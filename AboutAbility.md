...
2. 你的敏捷與感知中較高的一項所具有的附加成功，可以作為防御的附加成功。使用1點防御的附加成功，可以抵消攻擊的1個成功。若攻擊的成功數被抵消到0，則本次攻擊失手，附加成功無效。

3. 依據屬性不同，獲得下表的效果：

* 力量：每1點附加成功，可以使人物的跳躍檢定結果+1，并且在進行力量檢定時，可以額外將1DP轉化為1附加成功。

* 敏捷：每1點附加成功，可以使人物的基礎移動速度+5米。

* 耐力：每1點附加成功，可以使人物的生命值+2。

* 智力：每次獲得附加成功時立刻執行以下動作：
  1. 將一種語言提升1級。
  2. 獲得2個專業點。
  3. 選擇一個未滿3級的技能，將其提升1級。

* 感知：每1點附加成功，可以使人物的敏感范圍增加20米。

* 決心：每1點附加成功，可以使人物的意志力池+2。

* 風度：每1點附加成功，可以使人物在進行機運骰和幸運檢定時在檢定結果上+1，并在防御上獲得+2DP幸運加值。

* 操控：每1點附加成功，可以使人物在一天中重投一次任意檢定（包括機運骰）。你必須接受重投的結果，即使這次結果比上次更差。此外，在進行操控檢定時，你可以將1點附加成功轉化為5DP。

* 沉著：每1點附加成功，可以使人物的先攻+1d10，并且在意志檢定中得到2DP表現加值。
